...
*/
    ...
    {
        printf( ( "WiFi library initialized.\n") );
    }
    else
    {
        printf( ( "WiFi library failed to initialize.\n" ) );
    ...
    else
    {
        ...
        xWifiStatus = WIFI_Off(); // Turn off Wi-Fi module
    }
}
...
//    ESP_ERROR_CHECK( nvs_flash_init() );
    ...
    printf("\r\n\n");
//TODO: currentry spiffs not available on M5Stack
//	vfs_spiffs_register();
//    if (!spiffs_is_mounted) {
    	_fg = TFT_RED;
